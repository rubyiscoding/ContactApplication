    ...
    override func viewWillDisappear(_ animated: Bool) {
        ...
        if contacts != nil{
            ...
            if firstNameTextField.text != "" || lastNameTextField.text != ""{
                contactsList.createContact(firstName: firstNameTextField.text!, lastName: lastNameTextField.text!, phoneNumber: phoneNumberTextField.text!, email: emailTextField.text!)
            }
        }
    }
